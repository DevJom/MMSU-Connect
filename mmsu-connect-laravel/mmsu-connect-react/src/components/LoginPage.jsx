...
export const LoginPage = () =>{
    return(
        ...
        <div className="navbar bg-green-800 p-8 border-y-4  border-y-amber-400 scrol">
        <div className="navbar-start">
            ...
            <a className="btn btn-ghost text-4xl text-gray-50 ">MMSU Connect</a>
        </div>


        <div className="navbar-center hidden lg:flex  text-gray-50">
            <ul className="menu menu-horizontal px-1  text-sm">
                ...
                <li>
                     <details>
                        ...
                        <ul className="p-3 w-48 bg-green-700">
                            <li><a>NEWS</a></li>
                            <li><a>EVENTS</a></li>
                             <li><a>ANNOUNCEMENTS</a></li>
                        </ul>
        ...
        <div className="navbar-end pr-10 lg:">
            <a className="btn btn-ghost hidden lg:flex text-gray-50 text-xl">Register</a>
        </div>
        </div>
        ...
        {/* start footer*/}
        <footer className="footer grid-rows-1 pl-80 pt-10 pb-10  text-lg bg-green-800 text-gray-50 border-t-4  border-t-amber-400 scrol">
            <nav>
