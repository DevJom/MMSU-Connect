  ...
  return (
    <div className="menu w-80 min-h-full bg-base-200">
      ...
      <div className="p-4">
        ...
        <div className="hover:bg-gray-200">
          {" "}
          <a href="/developers" className="flex w-auto items-center pb-2 space-x-2 ">
      ...
      <div className="p-4">
        <div className="hover:bg-gray-200">
          <a href="/setting" className="flex w-auto items-center pb-2 space-x-2">
        ...
        <div className="hover:bg-gray-200">
          {" "}
          <a href="/logout" className="flex w-auto items-center pb-2 space-x-2 ">
